...
//! ASCII/текстовой развёртки таблица подготавливается к отдельному файлу,
//! а в тексте сообщения остаётся только ссылка на его имя. Запись выполняется
//! явной командой экспорта ресурсов.
